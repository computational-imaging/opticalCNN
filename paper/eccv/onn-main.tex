...
\title{ClassificationCam: An exploration of hybrid and fully optical convolutional neural networks} % Replace with your title
...
\begin{itemize}
\item CNNs for computer vision
\item Computational imaging and embedded vision
\item Optical computing, optical neural networks	
\end{itemize}
